...
# Text chunking with user-defined chunk size and overlap
...
def main():
    ...
    chunk_size = st.sidebar.number_input("Chunk Size", min_value=1000, max_value=20000, step=1000, value=10000)
    chunk_overlap = st.sidebar.number_input("Chunk Overlap", min_value=0, max_value=5000, step=100, value=1000)
